...
class ParticipantData (models.Model):
    ...
    email_id = models.EmailField(verbose_name="Enter your Email ID")
    ...
    event_list = models.CharField(max_length=200,choices=CHOICES,blank=True,null=True)
    ...
    def clean(self):
        ...
        if (self.registration_type=="Individual" and self.no_of_people!=1):
            # # raise error for field
            #     flag=False
               raise ValidationError({'registration_type': ["You have selected Individual , please select group if you are participating as group. If not then No. of people should be 1.",]})
