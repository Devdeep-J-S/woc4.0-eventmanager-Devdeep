...
class Eventdata (models.Model):
    ...
    description = models.TextField(verbose_name="Event's description",default="This is Description box.",blank=True)
    link =models.URLField(	verbose_name = "Link of the poster", max_length=10000,blank=True)
    From = models.DateTimeField(verbose_name="From",null =True,help_text="Note : time in UTC")
    To= models.DateTimeField(verbose_name="To",null =True,help_text="Note : time in UTC")
    reg_deadline = models.DateTimeField(verbose_name="Registration Deadline",null =True,help_text="Note : time in UTC")
    host_email =models.EmailField(verbose_name="Host\'s Email ID",default="your email address")
